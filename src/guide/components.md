...
```typescript:line-numbers [TS支持 - auto-imports.d.ts]
/* eslint-disable */
/* prettier-ignore */
// @ts-nocheck
...
```json:line-numbers [ESLint支持 - .eslintrc-auto-import.json]
{
  "globals": {
    "Component": true,
...
<script setup lang="ts">
/**
 * TypeScript Helper:  formGroupsDefiner / formRulesDefiner / formGridDefiner
 */
...
```typescript:line-numbers [TS支持 - tsconfig.json]
{
  "compilerOptions": {
    "types": [
      "@antd-templater/library-3.x/library-declare", // [!code highlight]
...
```javascript:line-numbers [ESLint支持 - .eslintrc.cjs]
module.exports = {
  extends: [
    "eslint:recommended",
    "plugin:vue/vue3-recommended",
    "plugin:@typescript-eslint/eslint-recommended",
    "./node_modules/@antd-templater/library-3.x/library-eslintrc.json", // [!code highlight]
